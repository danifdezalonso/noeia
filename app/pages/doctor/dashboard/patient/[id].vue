  ...
  <div class="flex-1 overflow-y-auto min-h-0">
    <div class="p-4 sm:p-6 space-y-6 max-w-[1100px]">
      ...
      <div class="flex items-center gap-2 text-sm">
        <Button variant="ghost" size="icon-sm" @click="navigateTo('/doctor/dashboard/patients')">
          <ArrowLeft class="w-4 h-4" />
        </Button>
        <span class="text-muted-foreground cursor-pointer hover:text-foreground" @click="navigateTo('/doctor/dashboard/patients')">Patients</span>
