                ...
                <div class="space-y-3">
                  ...
                  >
                    ...
                    <div v-if="plan.recommended" class="absolute -top-2.5 left-1/2 -translate-x-1/2">
                      <span class="bg-primary text-primary-foreground text-[10px] font-semibold px-3 py-0.5 rounded-full whitespace-nowrap">
                        Recommended
                      </span>
                    </div>
    ...
    <div class="hidden lg:flex flex-col justify-between bg-sidebar border-l border-border px-10 py-10 relative overflow-hidden">
      ...
      <div class="relative max-w-sm">
        ...
        <div class="flex flex-wrap gap-2">
          <span
            v-for="f in ['Multi-doctor', 'Billing automation', 'Team management', 'Analytics']"
            :key="f"
